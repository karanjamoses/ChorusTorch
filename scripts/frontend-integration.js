 ...
 * This file demonstrates how to integrate Chorustorch with a web frontend
 */

// For React/Vue/Angular applications
export class ChorustorchClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ChorustorchClient(provider, contractAddress);
