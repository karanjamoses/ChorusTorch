...
const contractABI = require("../artifacts/contracts/Chorustorch.sol/Chorustorch.json").abi;

program
    .name("chorustorch-cli")
    .description("CLI tool for Chorustorch smart contract")
    .version("1.0.0");
